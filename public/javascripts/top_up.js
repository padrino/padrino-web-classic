...
// *
// * $Date: 2010-02-26 18:07:20 +0100 (Fri, 26 February 2010) $
// *
...
TopUp = (function() {
  ...
  var prepare = function() {
    ...
    if ((parseInt(options.modal, 10) == 1) || (parseInt(options.shaded, 10) == 1) || (parseInt(options.overlayClose, 10) == 1)) {
      ...
      if (jQuery.ie6){
        jQuery("#tu_overlay").css({ height: jQuery(document).height() });
      }
  ...
  var show = function() {
    ...
    switch(options.effect) {
      ...
      case "transform":
        ...
        break;
      default:
        jQuery("#top_up").show("fast", afterDisplay);
    }
  };
  ...
  var animateHide = function(callback) {
    ...
    switch(options.effect) {
      ...
      case "transform":
        ...
        break;
      default:
        jQuery("#top_up").hide("fast", afterHide);
    }
